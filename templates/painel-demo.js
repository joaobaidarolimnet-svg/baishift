/* O painel do provedor: as três áreas (comercial, financeiro, campo) e o painel
   completo com troca de período. Mora na página inicial e na página do produto.
   Os textos vêm do JSON; os números são ilustrativos e vivem no assets/js/site.js. */
"use strict";
...
const HUD = `<!-- ===================== PAINEL COMPLETO ===================== -->
<section class="hud" id="completo" aria-labelledby="h-completo">
  <div class="wrap">
    <div class="hud-head">
      <div class="rv"><h2 id="h-completo" style="font-size:clamp(1.5rem,3vw,2.2rem)">O painel completo, com o período que a diretoria escolhe</h2>
...
/* as duas seções juntas, na ordem em que são lidas */
function painelCompleto(c) {
  return demoDoPainel(c) + "\n" + HUD;
}

module.exports = { painelCompleto, demoDoPainel, HUD };
