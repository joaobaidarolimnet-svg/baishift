...
const PAGINAS = { hub: render.paginaHub, provedores: render.paginaProvedores, dashboards: render.paginaPaineis, apps: render.paginaApps };

/* chega por <form method="post" target="_blank"> (urlencoded):
   conteudo=<json>&pagina=hub|provedores|dashboards|apps|produto:<slug> */
